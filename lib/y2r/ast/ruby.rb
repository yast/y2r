...
module Y2R
  module AST
    ...
    module Ruby
      # Context passed to the #to_ruby method on nodes.
      ...
      class Node < OpenStruct
        ...
        def to_ruby_enclosed
          enclose? ? "(#{to_ruby})" : to_ruby
        end
      ...
      class Assignment < Node
        def to_ruby
          ...
          if rhs.is_a? Variable
            "#{lhs.to_ruby} = deep_copy(#{rhs.to_ruby})"
          else
      ...
      class UnaryOperator < Node
        def to_ruby
          "#{op}#{expression.to_ruby_enclosed}"
        end
      ...
      class BinaryOperator < Node
        def to_ruby
          "#{lhs.to_ruby_enclosed} #{op} #{rhs.to_ruby_enclosed}"
        end
      end

      class Ternary < Node
        def to_ruby
          condition.to_ruby_enclosed +
            " ? " + self.then.to_ruby_enclosed +
            " : " + self.else.to_ruby_enclosed
        end
      end
